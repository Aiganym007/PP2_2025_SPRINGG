...
snake = Snake()
if progress:
    snake.score, snake.level = progress
    print(f"Прогресс загружен: Счёт = {snake.score}, Уровень = {snake.level}")
else:
    print("Новый пользователь. Удачи!")
print("Загрузка прогресса завершена!")
