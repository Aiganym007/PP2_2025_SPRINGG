        ...
        if not snake.move():
            ...
            while waiting_for_restart:
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.KEYDOWN:
                        if event.key == pygame.K_w:  # Press W to restart the game
                            snake.reset()  # Reset the snake and food
                            food.generate_random_pos(snake)  # Regenerate the food position
                            waiting_for_restart = False  # Exit the waiting loop
            continue  # Skip the rest of the main loop after game over
